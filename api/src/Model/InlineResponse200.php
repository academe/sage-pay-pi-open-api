...
class InlineResponse200 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'amount' => '\Academe\SagePay\PiSdk\Model\AmountObject',
     ...
     * Gets amount
     *
     * @return \Academe\SagePay\PiSdk\Model\AmountObject|null
     */
     ...
     * Sets amount
     *
     * @param \Academe\SagePay\PiSdk\Model\AmountObject|null $amount amount
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency of the `amount` in 3 letter [ISO 4217 format](http://en.wikipedia.org/wiki/ISO_4217). *This is only returned in GET requests*
     *
     * @return $this
     */
    public function setCurrency($currency)
    {
        if (! is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling InlineResponse200., must be smaller than or equal to 3.');
        }
        if (! is_null($currency) && (mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling InlineResponse200., must be bigger than or equal to 3.');
        }
