...
/**
 * MerchantSessionKeys Class Doc Comment
 *
 * @category Class
 * @package  Academe\SagePay\PiSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MerchantSessionKeys implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantSessionKeys';
     ...
     *
     * @param string|null $merchantSessionKey merchantSessionKey
     *
     * @return $this
     */
     ...
     * Sets expiry
     *
     * @param string|null $expiry Date/Time in [ISO 8601](http://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations) format
     *
     * @return $this
     */
