...
class InlineObject1 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cardholderName'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'cardholderName');
        }
        if ($this->container['cardNumber'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'cardNumber');
        }
        if ($this->container['expiryDate'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'expiryDate');
        }
     ...
     * Sets expiryDate
     *
     * @param string $expiryDate The expiry date of the card in `MMYY` format
     *
     * @return $this
     */
     ...
     * Sets securityCode
     *
     * @param string|null $securityCode The card security code, also known as CV2, CVV, or CVC. This is used in CV2 checks.
     *
     * @return $this
     */
