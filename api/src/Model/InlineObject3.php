...
class InlineObject3 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['paRes'] === null) {
            $invalidProperties[] = sprintf('"%s" can\'t be null', 'paRes');
        }
    ...
    {
        return $this->get('paRes');
    }

    /**
     * Sets paRes
     *
     * @param string $paRes A Base64 encoded, encrypted message with the results of the 3-D Secure authentication.
     *
     * @return $this
     */
